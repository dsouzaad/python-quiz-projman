...
from PySide6.QtWidgets import (QApplication, QMainWindow, QWidget, QVBoxLayout, QHBoxLayout, QLabel, QPushButton, QRadioButton)
...
app.setStyleSheet("QWidget { color : rgb(30, 30, 30); font-size : 14px; font-family : courier new; }")
...
certain_reward_button = QPushButton("Correct answer gets 100pts, a Wrong answer gets 0 pts")
uncertain_reward_button = QPushButton("Correct answer gets x2 points, Wrong answer halves my points")
...
""")
certain_reward_button.setStyleSheet("QPushButton { background-color: rgb(135, 205, 248) }")
# Set up initial page
...
# Set up controller
controller = OOPQuestionController(main_window, main_layout, dialouge_label, bottom_button_widget, next_button, back_button, points_label, oop_quiz_label, code_snip_label, question_label, answer_one_button, answer_two_button, answer_three_button, submit_button, secondary_window, answer_status_label, question_info_label, reward_info_label, certain_reward_button, uncertain_reward_button, top_widget, top_layout, middle_widget, middle_layout, left_middle_widget, left_middle_vbox,right_middle_widget,
    right_middle_vbox,
    bottom_widget,
    bottom_layout,)
